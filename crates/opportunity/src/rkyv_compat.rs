//! Phase 3 P3-C per-crate rkyv-with adapters for the alloy-primitives
//! types embedded in `OpportunityEvent`. Same shape and rationale as
//! `crates/ingress/src/rkyv_compat.rs` and `crates/state/src/rkyv_compat.rs`
//! from P3-A; lives per-crate (not in `crates/types`) per Codex
//! direction (2026-05-04 15:10:16 +09:00).
