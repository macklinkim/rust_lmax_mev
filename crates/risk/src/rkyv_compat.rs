//! Phase 3 P3-D per-crate rkyv-with adapters for the alloy-primitives
//! types embedded in `RiskCheckedOpportunity` / `OpportunityAborted`.
//! Same shape and rationale as `crates/{ingress,state,opportunity}/src/
//! rkyv_compat.rs` from P3-A and P3-C; lives per-crate (not in
